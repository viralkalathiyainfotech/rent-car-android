...
class RegisterViewModel @Inject constructor(
    ...
    fun register(
        ...
        if (licenceNo.isBlank())         { _registerState.value = UiState.Error("Driving licence number is required"); return }
        if (licenceNo.length < 5)        { _registerState.value = UiState.Error("Enter a valid driving licence number"); return }
